...
涉及文件：`index.html`、`event.html`、`projects.html`、`assets/css/styles.css`、`assets/js/app.js`、`assets/js/event-chain.js`、`root/root.js`、`root/root.css`、`tests/buttons.spec.ts`、`tests/event-chain.spec.ts`、`tests/root-admin.spec.ts`、`README.md`。
