...
按钮 / 交互自动化测试基于 [Playwright Test](https://playwright.dev)，覆盖公共首页主题切换、hero CTA、nav 锚点、demo tabs、评分、提交流程、Reveal 入场、跑马灯，以及 `/root/` 后台管理 MVP 的 root 初始化、报名审核、问卷配置、项目公开和赛事预览联动。
...
- 作品展示预览。
- 端口和 API 摘要。
- `/root/` 后台管理 MVP：概览、活动管理、报名管理、项目看板、赛事预览、邮件中心。
